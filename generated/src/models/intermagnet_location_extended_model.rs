...
impl IntermagnetLocationExtendedModel {
    pub fn new(concurrency: uuid::Uuid, created_at: String, elevation: f64, iaga: String, id: uuid::Uuid, intermagnet_ids: Vec<uuid::Uuid>, name: String, status: Option<models::IntermagnetLocationStatus>, updated_at: String) -> IntermagnetLocationExtendedModel {
