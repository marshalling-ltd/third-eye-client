...
impl PagedResponseUserModelItemsInner {
    pub fn new(concurrency: uuid::Uuid, created_at: String, email: String, id: uuid::Uuid, is_active: bool, name: String, password: String, role: models::UserRole, surname: String, updated_at: String) -> PagedResponseUserModelItemsInner {
